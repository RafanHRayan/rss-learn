---
description: Inequality and inequality properties, postulates, and theorems.
---
...
Previously, we have look at equality ($$=$$) and congruence ($$\cong$$).

In this unit, six symbols will be introduced:
...
For any four real numbers where $$a>b$$ and $$c≥d$$, $$(a+b)>(c+d)$$.
{% endhint %}
...
If the measures of two angles in a triangle are unequal, then the larger angle is always opposite the longer angle.
{% endhint %}
...
If a triangle's points are all collinear, then the triangle is a **degenerate triangle**.
