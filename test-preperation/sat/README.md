...
{% content-ref url="general-sat-strategies.md" %}
[general-sat-strategies.md](general-sat-strategies.md)
{% endcontent-ref %}

{% content-ref url="reading-sat-strategies.md" %}
[reading-sat-strategies.md](reading-sat-strategies.md)
{% endcontent-ref %}

{% content-ref url="writing-sat-strategies.md" %}
[writing-sat-strategies.md](writing-sat-strategies.md)
{% endcontent-ref %}

{% content-ref url="mathematics-sat-strategies.md" %}
[mathematics-sat-strategies.md](mathematics-sat-strategies.md)
{% endcontent-ref %}
