---
description: >-
  Life processes, scientific method, experiment design, graphing, and lab tool
  usage.
---
...
<summary><i class="fa-thought-bubble">:thought-bubble:</i> <strong>Scenario 1</strong> — <em>Premasin 86</em> Experiment</summary>
...
{% columns %}
{% column %}
<div data-with-frame="true"><figure><img src="../../.gitbook/assets/unnamed-chunk-179-1.png" alt=""><figcaption><p><strong>Image 1</strong> — Sample scatterplot.</p></figcaption></figure></div>
{% endcolumn %}
...
{% column %}
<div data-with-frame="true"><figure><img src="../../.gitbook/assets/Bar-Chart-01.png" alt=""><figcaption><p><strong>Image 3</strong> — Sample bar graph.</p></figcaption></figure></div>
{% endcolumn %}
{% endcolumns %}
