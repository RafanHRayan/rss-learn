---
description: >-
  Levels of organization, ecosystems, biomass, energy, organismal relationships,
  population growth, ecological succession, carbon cycle, and nitrogen cycle.
---
...
<summary><i class="fa-bookmark-plus">:bookmark-plus:</i> <strong>Additional Concept</strong> — Aquatic Succession</summary>
...
<div data-with-frame="true"><figure><img src="../../.gitbook/assets/Aquatic_Succession_outline_diagram.jpg" alt="" width="375"><figcaption><p><strong>Image 2</strong> — Aquatic succession.</p></figcaption></figure></div>
...
Plants need nitrogen to grow, and 78% of our atmosphere is nitrogen gas. We call this atmospheric nitrogen (N<sub>2</sub>). Plants need nitrogen to build proteins. A lot of nitrogen is in the air as atmospheric nitrogen, but plants can't use it. Plants get nitrogen from nitrates (NO<sub>3</sub><sup>–</sup>).
...
[Photosynthesis](cellular-respiration-and-photosynthesis.md#photosynthesis) is the process plants use to make their own energy. Plants take in carbon dioxide, light energy, and water. They then convert them into oxygen and ATP.
